...
- [x] 13. Реализовать стартовый экран и вход по ссылке
...
- [x] 14. Реализовать UI управления микрофоном, камерой и выходом
...
- [x] 15. Реализовать экран комнаты и видеосетку
